          ...
          child: Center(
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Text('Add a new category', style: TextStyle(
                        fontSize: 30
                    ),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        context.read(newCategoryProvider).category.name = toBeginningOfSentenceCase(textController.text)!,
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(onPressed: ()=>showOverlay(context), child: Text('Click Me'))
          ],
        ),
      ),
    ),
